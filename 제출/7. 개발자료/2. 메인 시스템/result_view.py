...
"color: rgb(255, 255, 255);")
        ...
        self.imgLabel.setGeometry(QtCore.QRect(370, 130, 261, 261))
        self.imgLabel.setText("")
        self.imgLabel.setObjectName("imgLabel")
        self.resultLabel = QtWidgets.QLabel(Dialog)
        self.resultLabel.setStyleSheet("font: 75 14pt \"맑은 고딕\";")
        self.resultLabel.setGeometry(QtCore.QRect(30, 190, 311, 91))
    ...
    def updateResultView(self, result):
        ...
        self.imgLabel.setPixmap(QtGui.QPixmap(link))

    def saveFile(self, voiceName, result):
        root = Tk()
        root.withdraw()
        root.file = filedialog.asksaveasfile(mode='w', defaultextension=".txt")
        ...
        text = "파일명 : " + voiceName + "\n"
        text += "분석 날짜 : " + str(datetime.now()) + "\n"
        text += "분석 결과 : " + emotion + "\n"

        root.file.write(text)
        root.file.close()
        root.destroy()
